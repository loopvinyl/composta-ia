...
Para liberar o aplicativo completo, faça UMA das opções:
  1) Altere a variável MOSTRAR_EM_BREVE_LOCAL para False (abaixo);
  2) Ou defina nos Secrets do Streamlit Cloud:
         MOSTRAR_EM_BREVE = false
  3) Ou crie o arquivo .streamlit/secrets.toml com:
         MOSTRAR_EM_BREVE = false

Quando liberado, este arquivo importa o módulo `composta_ia`,
que contém todo o código do aplicativo (abas, IA, cálculos, gráficos).
"""
...
# =========================================================
# 🚧 PÁGINA DE AVISO — "Em breve de volta ao ar"
# =========================================================
if MOSTRAR_EM_BREVE:
    st.markdown(
        """
        ...
        <div class="pagina-container">
            ...
            <div class="pagina-header">
                ...
                <p class="pagina-subtitulo">
                    Potencial de Compostagem e Créditos de Carbono para os municípios brasileiros
                </p>
            </div>
            ...
            <div class="cards-grid">
                <div class="card">
                    ...
                    <p class="card-texto">
                        Interpreta automaticamente os tipos de coleta e destinação
                        declarados pelos municípios no SINISA (2023 e 2024).
                    </p>
                </div>
                ...
                <div class="card">
                    ...
                    <p class="card-texto">
                        Usa Processamento de Linguagem Natural (PLN) para reconhecer
                        e padronizar as variações textuais dos destinos finais.
                    </p>
                </div>
                ...
                <div class="card">
                    ...
                    <p class="card-texto">
                        Estima quanto do resíduo orgânico coletado pode ser desviado
                        do aterro e transformado em composto, por município.
                    </p>
                </div>
                ...
                <div class="card">
                    ...
                    <p class="card-texto">
                        Calcula as emissões de metano (CH₄) dos aterros, lixões e
                        aterros controlados, seguindo a norma
                        <strong>UNFCCC A6.4-AMT-003</strong>.
                    </p>
                </div>
                ...
                <div class="card">
                    ...
                    <p class="card-texto">
                        Estima o valor financeiro das emissões evitadas com a
                        compostagem, usando cotação real de carbono e câmbio EUR/BRL.
                    </p>
                </div>
                ...
                <div class="card">
                    ...
                    <p class="card-texto">
                        Projeta a expansão da coleta seletiva, simula receitas futuras
                        e identifica municípios prioritários para políticas públicas.
                    </p>
                </div>
                ...
                <div class="card">
                    ...
                    <p class="card-texto">
                        Identifica municípios acima dos limiares de 10.000 e 25.000
                        tCO₂e/ano, subsidiando o Sistema Brasileiro de Comércio de
                        Emissões e a Etapa 2 (Resíduos).
                    </p>
                </div>
                ...
                <div class="card">
                    ...
                    <p class="card-texto">
                        Abrange os <strong>5.570 municípios brasileiros</strong>,
                        com painéis comparativos por estado e por porte populacional.
                    </p>
                </div>
            </div>
            ...
            <ul class="timeline">
                <li class="passado">
                    ...
                    <p class="timeline-texto">
                        O aplicativo foi publicado e permaneceu no ar em ambiente
                        de testes, com validação dos cálculos, das bases do SINISA
                        e da metodologia UNFCCC aplicada.
                    </p>
                </li>
                <li class="atual">
                    <span class="ponto"></span>
                    ...
                    <p class="timeline-texto">
                        Consolidação metodológica, ajustes finais e encaminhamentos
                        legais necessários para a liberação definitiva da plataforma.
                    </p>
                </li>
                <li class="futuro">
                    <span class="ponto"></span>
                    ...
                    <p class="timeline-texto">
                        Retorno do Composta.IA com <strong>todas as funcionalidades
                        liberadas</strong>: análise completa dos municípios,
                        diagnósticos, projeções, simulações de créditos de carbono
                        e painéis comparativos nacionais.
                    </p>
                </li>
            </ul>
